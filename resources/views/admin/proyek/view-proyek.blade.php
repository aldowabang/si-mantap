            ...
            <div class="row mb-3">
                <div class="row mt-3">
                    <div class="col-md-6 d-flex align-items-center">
                        @if ($proyek->file_path)
                            <button type="button" class="btn btn-primary ml-3 mr-2" data-toggle="modal" data-target="#pdfModal">
                                Dokumen
                            </button>
                            <!-- Modal -->
                    ...
                    <div class="col-md-6 d-flex align-items-center">
                        ...
                        @if ($proyek->monitorings && count($proyek->monitorings) > 0)
                            <a href="{{ route('proyek-monitoring-admin', $proyek->id) }}" target="_blank" class="btn btn-success">
